...
// camera
glm::vec3 cameraPos = glm::vec3(-57.491f, 18.548f, 28.485f);//初始位置
glm::vec3 cameraFront = glm::vec3(0.044f, -0.350f, -0.406f);
...
//光源位置：
Light cubeLight(0.0f, 10.0f, -5.0f,0.7f, 0.4f,0.9f,200.0f);
Light light02(20.0f, -10.0f, 30.0f, 0.9f, 0.7f, 0.4f, 200.0f,1.6f);
...
int main()
{
    ...
    //导入人头模型......................................
    Shader headShader("headShader.v", "headShader.f");
    headShader.use();
    ...
    Matiral ballMaterial = setMatiral(0.4, 0.05, "Glass");//设定实例化物体的材质
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubeTexture0);
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubTexture1);
        glActiveTexture(GL_TEXTURE2);
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubTexture2);
        glActiveTexture(GL_TEXTURE3);
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubTexture3);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        glDepthFunc(GL_LESS);
        ...
        //人头模型
        headShader.use();
        headShader.setMat4("transform", translation);
